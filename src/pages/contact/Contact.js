            ...
            <main id='main-main' className='bg-[#F6F5F4]'>
                <section className='w-[100%] flex justify-center items-center p-[2rem] mt-[4rem] lg:py-[4rem]'>
                    <section className='w-[100%] lg:w-[60%] lg:p-[2rem]'>
                        <a className='transition hover:scale-[1.02] flex items-center bg-white my-[1rem] lg:my-[1.5rem] cursor-pointer p-[1rem] lg:p-[2rem] shadow-[0_0_25px_4px_#34292714] rounded-[1rem]'>
